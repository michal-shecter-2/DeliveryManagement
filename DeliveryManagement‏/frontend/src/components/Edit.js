                    ...
                    <div class="col-md-8">
                        <div class="p-3 py-5">
                            ...
                            <div class="row mt-3">
                                ...
                                <div div class="col-md-6"><button class="btn btn-primary profile-button" type="button" onClick={() => onClick('displayResponsive')}>Change your password</button></div>
                                <Dialog header="Change password" visible={displayResponsive} onHide={() => onHide('displayResponsive')} breakpoints={{ '960px': '75vw' }} style={{ width: '50vw' }} footer={renderFooter('displayResponsive')}>
                                    <h6><b>Enter your password</b></h6>
                                    <Password class="form-control" placeholder="your password" value={value1} onChange={(e) => setValue1(e.target.value)} feedback={false} toggleMask />
                                    {value1 == user.password ?
                                        <div> <h6><b>Enter your new password</b></h6>
                                            <Password class="form-control" placeholder="your new password" value={value3} onChange={(e) => setValue3(e.target.value)} toggleMask />
                                        </div> : " "}
                                </Dialog>
                            ...
                            <div class="row mt-3">
                                <Autocomplete
                                    ...
                                    style={{ width: 300 }}
                                    renderInput={(params) => <TextField {...params} label=" עיר  בחר" variant="outlined" defaultValue={user.citycode} />}
